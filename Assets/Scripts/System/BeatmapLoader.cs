...
public class BeatmapLoader : MonoBehaviour 
{
    ...
    {
        if (SystemData.beatmapPath == null)
        {
        ...
        if (SystemData.beatmaps.Count == 0)
        {
            LoadBeatmap();
        }
    }
    ...
    {
        string[] folders = Directory.GetDirectories(SystemData.beatmapPath);
